    ...
    <form id="flowForm" name="flowForm" method="post" action="">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="3" class="teacher">
              讲师：{{ order.teacherName }}
            </td>
          </tr>
          <tr class="good">
            <td class="name First">
              <a target="_blank" :href="'https://120.77.81.245:3000/course/'+order.courseId">
                <img :src="order.courseCover"></a>
              <div class="goodInfo">
                <input type="hidden" class="ids ids_14502" value="14502">
                <a target="_blank" :href="'https://120.77.81.245:3000/course/'+ order.courseId">{{ order.courseTitle }}</a>
              </div>
            </td>
            <td class="price">
      ...
      <div class="Finish">
        ...
        <div class="Main fl">
          ...
          <div class="fr">
            <p>
              共 <strong class="red">1</strong> 件商品，合计<span class="red f20">￥<strong
                id="AllPrice"
